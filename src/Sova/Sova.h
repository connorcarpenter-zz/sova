...
static const int dispWidth = canvasWidth * 2;
static const int dispHeight = canvasHeight * 2;
...
//--
void
Sova::setupCanvas(const TextureSetup& rtSetup) {
...
const void*
Sova::updateVertices(int& outNumBytes) {
    int vIndex = 0;
...
//------------------------------------------------------------------------------
int
Sova::writeVertex(int index, float x, float y, float u, float v) {
